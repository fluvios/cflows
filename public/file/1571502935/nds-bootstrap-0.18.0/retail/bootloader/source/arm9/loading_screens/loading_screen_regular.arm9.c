...
void arm9_loadingCircle( void ) {
  ...
  if ( loadingCircleTime == 3 ) {
    ...
    drawRectangle ( 88, 64, 24, 24, dot[0] );
    drawRectangle ( 116, 64, 24, 24, dot[1] );
    drawRectangle ( 144, 64, 24, 24, dot[2] );

    drawRectangle ( 88, 92, 24, 24, dot[7] );
    drawRectangle ( 116, 92, 24, 24, baseColor );
    drawRectangle ( 144, 92, 24, 24, dot[3] );

    drawRectangle ( 88, 120, 24, 24, dot[6] );
    drawRectangle ( 116, 120, 24, 24, dot[5] );
    drawRectangle ( 144, 120, 24, 24, dot[4] );
