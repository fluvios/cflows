 ...
 */
static int bootutil_img_hash( struct image_header *hdr, const struct flash_area *fap,
...
static int bootutil_find_key( uint8_t *keyhash, uint8_t keyhash_len ) {
  bootutil_sha256_context sha256_ctx;
  int i;
 ...
 */
int bootutil_img_validate( struct image_header *hdr, const struct flash_area *fap,
                           uint8_t *tmp_buf, uint32_t tmp_buf_sz,
