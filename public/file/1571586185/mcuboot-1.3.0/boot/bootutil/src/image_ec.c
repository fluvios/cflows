 ...
 */
static int bootutil_parse_eckey( mbedtls_ecdsa_context *ctx, uint8_t **p, uint8_t *end ) {
  size_t len;
...
static int bootutil_cmp_sig( mbedtls_ecdsa_context *ctx, uint8_t *hash, uint32_t hlen,
