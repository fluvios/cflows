 ...
 */
static int tinycrypt_import_key( uint8_t **cp, uint8_t *end ) {
  size_t len;
 ...
 */
static int tinycrypt_read_bigint( uint8_t i[NUM_ECC_BYTES], uint8_t **cp, uint8_t *end ) {
  size_t len;
 ...
 */
static int tinycrypt_decode_sig( uint8_t signature[NUM_ECC_BYTES * 2], uint8_t *cp, uint8_t *end ) {
  int rc;
  size_t len;
...
int bootutil_verify_sig( uint8_t *hash, uint32_t hlen, uint8_t *sig, size_t slen,
                         uint8_t key_id ) {
  int rc;
  uint8_t *pubkey;
  uint8_t *end;
